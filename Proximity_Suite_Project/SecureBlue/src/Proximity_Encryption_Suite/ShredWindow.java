 ...
 * @author TheThoetha
 */
public class ShredWindow extends javax.swing.JDialog {
     ...
     */
    public ShredWindow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Fast Zero Overwrite", "Random Overwrite", "DOD Standard 5220.22.M", "NAVSO – RLL", "NATO standard", "VSITR standard", "DOD Standard 5220.28.M STD", "Peter Gutmann Method" }));

        jList1.setModel(listModel);
        jScrollPane2.setViewportView(jList1);

        jLabel3.setText("Select Shredding Method:");
...
//                        i = -1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShredWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ShredWindow dialog = new ShredWindow(new javax.swing.JFrame(), true);
