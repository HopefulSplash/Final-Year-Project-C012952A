 ...
 * @author TheThoetha
 */
public class DeleteWindow extends javax.swing.JDialog {
     ...
     */
    public DeleteWindow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Safe Delete", "Shred Delete", "Absolute Delete", "Random Fill Delete" }));

        jList1.setModel(listModel);
        jScrollPane2.setViewportView(jList1);

        jLabel3.setText("Select Delete Method:");
...
//                        i = -1;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DeleteWindow dialog = new DeleteWindow(new javax.swing.JFrame(), true);
