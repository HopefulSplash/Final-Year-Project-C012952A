 ...
 * @author TheThoetha
 */
public class EncryptWindow extends javax.swing.JDialog {
     ...
     */
    public EncryptWindow(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AES Encryption", "DES Encryption", "Triple DES Encryption" }));
...
//                        i = -1;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EncryptWindow dialog = new EncryptWindow(new javax.swing.JFrame(), true);
